            ...
            <div class="col-12">
                <div class="card card-default">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12">
                                <div class="selectgroup pt-2 w-100">
                                ...
                                <button v-if="editMode" class="btn btn-secondary" @click="addApp()">
                                    <i class="fe fe-plus-circle"></i> Añadir Sección
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <button v-if="selectedApp.tutorial_sections.length === 0"
                                                  class="alert alert-secondary w-100" disabled>No hay secciones para
                                                        esta aplicación.
                                                    </button>
                                ...
                                <div class="row form-fieldset m-4">
                                    <div class="col-12">
                                        ...
                                        <div v-for="video in selectedSection.tutorial_videos" class="row mt-3">
                                            <div
                                                class="container form-control col-10 align-content-center m-auto mb-3 p-3">
                                        ...
                                        <div v-if="selectedSection.tutorial_videos.length === 0" class="row mt-3">
                                            <div
                                                ...
                                                <div class="col-12">
                                                    <p class="text-center mt-3">Esta área aún no cuenta con
                                                        video-tutoriales. Por favor, seleccione otra área.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
