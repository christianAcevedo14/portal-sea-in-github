                    ...
                    <div class="card text-dark pulse-button">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 p-5">
                                    <a href="https://www.microsoft.com/en-us/edge" class="nounderline text-dark"
                                       target="_blank">
                            ...
                            <p class="mt-3">Considere utilizar uno de los siguientes navegadores para obtener la mejor
